...
def main():
    ...
    (df_prices, df_conso) = extract_prices_concatenate_and_conso(PeriodStart, PeriodEnd, token, 'Europe/Paris', conso_path=conso_path)
    ...
    fusionned_table = fusionner_prix_conso_df(df_prix=df_prices, df_conso=df_conso)
    # Step 3: Load data
    print("\n=== LOADING ===")
